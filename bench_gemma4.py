"""
One-off benchmark script: gemma4:26b vs. the current qwen3-coder:30b
...
prior model bench on this project (2026-09-07 flash-attention test,
2026-09-08 qwen3.8 bench, 2026-09-10 qwen3-coder-next bench, 2026-09-13
muse-glimmer bench): real head-to-head, no trusting a leaderboard number.
...
bench alone, without paying for the full fabrication run too:
    ...
    python bench_gemma4.py coding
    python bench_gemma4.py fabrication
"""
import json
import subprocess
import sys
...
def run_fabrication_bench(model: str) -> None:
    ...
    for kind, question, note in FABRICATION_QUESTIONS:
        result = call(model, question, timeout=180)
