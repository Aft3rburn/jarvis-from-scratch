"""
One-off benchmark script: granite4.2:8b vs. the current qwen3-coder:30b
...
bench alone, without paying for the full fabrication run too:
    ...
    python bench_granite42_8b.py coding
    python bench_granite42_8b.py fabrication
"""
import json
import subprocess
import sys
...
def call(model: str, prompt: str, timeout: int = 300, think: bool = None) -> dict:
...
def run_coding_bench(model: str, think: bool = None) -> None:
...
def run_fabrication_bench(model: str, think: bool = None) -> None:
