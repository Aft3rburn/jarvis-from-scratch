"""
One-off benchmark script: muse-glimmer:30b vs. the current qwen3-coder:30b
...
project (2026-09-07 flash-attention test, 2026-09-08 qwen3.8 bench,
2026-09-10 qwen3-coder-next bench): real head-to-head, no trusting a
leaderboard number.

Usage: python bench_muse_glimmer.py
"""
import json
import subprocess
import sys
