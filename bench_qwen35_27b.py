"""
One-off benchmark script: qwen3.5:27b vs. the current qwen3-coder:30b
...
bench alone, without paying for the full fabrication/tool run too:
    ...
    python bench_qwen35_27b.py coding
    python bench_qwen35_27b.py tools
    python bench_qwen35_27b.py fabrication
"""
import json
import subprocess
import sys
