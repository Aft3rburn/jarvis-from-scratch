"""
One-off benchmark script: qwen3.6:35b-a3b vs. the current qwen3-coder:30b
...
bench alone, without paying for the full fabrication/tool run too:
    ...
    python bench_qwen36_35b.py coding
    python bench_qwen36_35b.py tools
    python bench_qwen36_35b.py fabrication
"""
import json
import subprocess
import sys
